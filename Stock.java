...
public class Stock extends Security {
  ...
  public Stock(String nbr, int date, double prc, double qty, String sym,
               String xchg, boolean div, int divDt,double amt) throws SecurityException{
  ...
  public String toString() {
    ...
    StringBuilder objInfo = new StringBuilder(String.format("The Stock belongs to Customer# %s;",
                                                            getCustNumber()));
